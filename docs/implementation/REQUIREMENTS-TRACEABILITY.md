...
**Status:** Phase 2 in progress (8/13 tasks complete); Phase 1 live benchmark remains blocked at 8/9; `NFR-03` is `Verified`; `INTAKE-01`, `INTAKE-03`, `INTAKE-05`, `ENTITY-01`, `ENTITY-02`, `ENTITY-03`, `ENTITY-04`, `ENTITY-05` and `ENTITY-07` are `Implemented`; `NFR-01`, `NFR-02`, `NFR-04`, `NFR-05`, `NFR-09`, `INTAKE-02`, `INTAKE-04`, `INTAKE-06`, `RUN-03`, `RUN-04`, `RUN-06`, `REPORT-06`, `REPORT-08` and `REPORT-09` are `In progress`; all other requirements remain `Specified`
...
| REPORT-06 | Distinguish fact/company claim/third-party/inference/conflict/unavailable | C6, C4 | `claims.claim_type`; block labels; source-tiered `Evidence` metadata and preserved prompt-injection flag | AT-REPORT-06, QG; `test_evidence_capture.py`; claim enum and provenance migration foundation | 2/4 | In progress |
