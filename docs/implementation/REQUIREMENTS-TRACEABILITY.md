...
| RUN-05 | Structured model outputs where feasible | C7 | `ModelGateway` validates caller-supplied Pydantic output schemas with exactly one bounded repair retry; deterministic fixture output is schema-checked | AT-RUN-05 (test_RUN_05_01, test_RUN_05_03, test_RUN_05_04) | 2 | Implemented |
