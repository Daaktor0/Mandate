...
**Status:** Phase 2 in progress (6/13 tasks complete); Phase 1 live benchmark remains blocked at 8/9; `NFR-03` is `Verified`; `INTAKE-01`, `INTAKE-03`, `INTAKE-05`, `ENTITY-01`, `ENTITY-02`, `ENTITY-03`, `ENTITY-04`, `ENTITY-05` and `ENTITY-07` are `Implemented`; `NFR-01`, `NFR-02`, `NFR-04`, `NFR-05`, `NFR-09`, `INTAKE-02`, `INTAKE-04`, `INTAKE-06`, `RUN-04`, `RUN-06`, `REPORT-06`, `REPORT-08` and `REPORT-09` are `In progress`; all other requirements remain `Specified`
...
| RUN-04 | Evidence stored separately from prose | C4 | `evidence`, `claims` vs `report_versions`; bounded evidence excerpts and normalised claim triples are separate persistence surfaces | AT-RUN-04, E2E-02; migration/pgTAP foundation | 2 | In progress |
...
| REPORT-06 | Distinguish fact/company claim/third-party/inference/conflict/unavailable | C6, C4 | `claims.claim_type`; block labels | AT-REPORT-06, QG; claim enum and provenance migration foundation | 2/4 | In progress |
...
| REPORT-08 | Dynamic research: last 3 FYs + current, or latest available | C6 | `claims.freshness` and `claims.period`; stage implementation pending | AT-REPORT-08; persistence foundation | 2 | In progress |
| REPORT-09 | Historical facts may extend to incorporation | C6 | `claims.freshness` and `claims.period`; stage implementation pending | AT-REPORT-09; persistence foundation | 2 | In progress |
